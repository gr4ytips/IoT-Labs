...
/**
  ...
  * The author and AI coauthor (ChatGPT) assume no liability for any misuse
  * or damage resulting from the use of this code.
  *  AI Code Refinement and Documentation: ChatGPT by OpenAI
  ******************************************************************************
  */
